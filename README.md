...
Tokens is issued by the server in exchange for login credentials for authentication. Like having a key to get through a locked door.

- [X] What steps can you take in your web apps to keep your data secure?
Having a privates routes in your code that are used to protect and render your code with authentication.

- [X] Describe how web servers work.
There are two ways to describe web servers, one bing physical web servers which stores the code for different websites to be shared across the world. And then there is the software web server which retrieves web pages from your project code to users upon a request.

- [X] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
The methods are create=post, read=get, update=put, and delete=delete. For example we have PUT which changes the resource’s information and delete which as its name implies deletes data that lives away from webpage.
